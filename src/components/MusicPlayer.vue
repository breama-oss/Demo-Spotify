  ...
  <q-footer class="player-footer" elevated>
    <div class="row items-center justify-between full-width">
      ...
      <div class="col-3 flex items-center">
        <q-img 
          :src="currentArtist?.albumCover || '/assets/default_cover.jpg'" 
